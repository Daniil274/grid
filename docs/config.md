...
| `max_tool_output_tokens` | `int` | Ограничение на количество токенов, выдаваемых инструментами (0 – без ограничения). | `8000` |
...
Конфигурация голосового ввода/вывода (STT/TTS).
...
| `api_key` | `string` | Ключ API (может быть произвольным). | `"lm-studio"` |
